...
export default function Page() {
  return <>
    ...
    <section className="section"><div className="container">
      ...
      <div className="banner" style={{ marginTop: 56 }}><div><h2>운영을 가볍게 시작해볼까요?</h2><p>별도 가입이나 승인 없이 운영자 프로필을 만들고 바로 시작할 수 있어요.</p></div><Link className="btn btn-accent" href="/community-host/start?redirect=/dashboard">운영지원 시작하기</Link></div>
    </div></section>
  </>;
}
